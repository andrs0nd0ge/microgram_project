...
import com.microgram.project.mapper.PostUserRowMapper;
...
public class PostDao {
    ...
    public List<Post> getAllPosts() {
        String sql = "select p.id as post_id, p.image_name, p.description, p.date, " +
                ...
                "from microgram.posts p " +
                "inner join microgram.users u on p.user_id = u.id";
    ...
    public List<Post> getPostsOfFollowedUsers(Long userId) {
        String sql = "select p.id as post_id, p.user_id, p.image_name, p.description, p.date, " +
                "u.id as user_id, u.name, u.username, u.email " +
                "from microgram.posts as p " +
                "left join microgram.users as u on p.user_id = u.id " +
                "left join microgram.subscriptions as s on u.id = s.subscribed_to_id " +
    ...
    public void updatePostsQty(Long userId) {
        String sql = "update microgram.users set post_qty = (select count(user_id) from users as u " +
    ...
    public void leaveCommentOnPost(CommentForPostsDto commentDto) {
        ...
        String sql = "insert into microgram.comments (text, date, post_id, user_id) " +
    ...
    public void deleteCommentOnPost(CommentForPostsDto commentDto) {
        ...
        String sql = "delete from microgram.comments as c " +
    ...
    public void leaveLikeUnderPost(Long userId, Long postId) {
        String sql = "insert into microgram.likes (user_id, post_id, date) " +
    ...
    public void makePost(MultipartFile file, String description, Long userId) throws IOException {
        ...
        String sql = "insert into microgram.posts (image, image_name, description, date, user_id) " +
    ...
    public void deletePost(Long userId, Long postId) {
        String sql = "delete from microgram.posts " +
    ...
    public Post getPostWithPicture(Long postId) {
        String sql = "select image from microgram.posts where id = :postId";
    ...
    public void unlikePost(Long userId, Long postId) {
        String sql = "delete from microgram.likes " +
